...
# So your program should word even with invalid IP Addresses. We're just interested in the
...
# 10.10t.10.10
# 12.9.34.6.12.90
# '' - that is, press and enter without typing anything

# This challenge is intended to pactice for loops and if/else statements, so although
# you could use other techniques (such as splitting the string up), that's not the
# approach we're looking for here.

ip = input("Type an valid IP\n")
segments = 0
